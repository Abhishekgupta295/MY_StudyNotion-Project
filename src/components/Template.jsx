...
const Template = ({title, desc1, desc2, formtype, image, setIsLoggedIn }) => {
  ...
  // console.log("this is my form type")
  return (
    <div className='flex justify-between w-11/12 max-w-[1160px] py-12 mx-auto gap-x-12 gap-y-0'>
      ...
      <div className='w-11/12 max-w-[450px]'>
            ...
            <p lassName='text-[1.125rem] leading[1.625rem] mt-4'>
              <span className=' text-yellow-300'>{desc1}</span> <br></br>
            ...
            <div className='flex w-full items-center my-4 gap-x-2'>
                ...
                <p className=' text-yellow-300 font-medium leading[1.375rem]'>OR</p>
                <div className='w-full h-[1px] bg-white'></div>
            </div>
